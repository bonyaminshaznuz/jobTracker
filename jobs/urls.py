...
urlpatterns = [
    ...
    path("<int:pk>/files/<str:file_type>/preview/", JobFilePreviewView.as_view(), name="file-preview"),
    path("<int:pk>/files/<str:file_type>/download/", JobFileDownloadView.as_view(), name="file-download"),
